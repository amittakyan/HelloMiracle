...
RUN wget -P maindownload --content-disposition "http://d04d1044.ngrok.io/nexus/service/local/artifact/maven/redirect?r=snapshots&g=HelloMiracle&a=HelloMiracle&v=LATEST&e=war"
