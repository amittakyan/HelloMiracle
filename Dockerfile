...
RUN wget -P maindownload --content-disposition "http://11ab4439.ngrok.io/nexus/service/local/artifact/maven/redirect?r=snapshots&g=HelloMiracle&a=HelloMiracle&v=LATEST&e=war"
