...
RUN wget -P maindownload --content-disposition "http://14fb2f2e.ngrok.io/nexus/service/local/artifact/maven/redirect?r=snapshots&g=HelloMiracle&a=HelloMiracle&v=LATEST&e=war"
